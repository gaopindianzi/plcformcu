...
PCA_P4:
    0, 缺省PCA 在P1  
    1，PCA/PWM 从P1  切换到P4  : ECI 从P1.2 切换到P4.1，
                                   PCA0/PWM0 从P1.3 切换到P4.2 
                                   PCA1/PWM1 从P1.4 切换到P4.3  
SPI_P4:
    0, 缺省SPI 在P1  
    1，SPI 从P1  切换到P4  : SPICLK 从P1.7 切换到P4.3  
                               MISO 从P1.6 切换到P4.2  
                               MOSI 从P1.5 切换到P4.1  
                               SS 从P1.4 切换到P4.0  
S2_P4: 
    0, 缺省UART2 在P1  
    1，UART2 从P1  切换到P4  : TxD2 从P1.3 切换到P4.3  
                                 RxD2 从P1.2 切换到P4.2  
GF2: 通用标志位
